...
**本契约不是**：会话消息（见姊妹契约）；不是广泛的 Moments 社区运营规则。评论**写向** v1.1 已纳入（§4.6·MVP 顶层评论）；评论**读向**（列评论）仍 v.next YAGNI。
...
*本契约版本：v1.1 / 2026-07-16（新增 §4.6 评论写动作·MVP 顶层评论；v1 = 读+点赞 2026-06-28）。major 改动另开新文件。*
